### Продажа/аренда коммерческой недвижимости
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <td style="text-align:left">Тип объекта-торговые площади</td>
                ...
                <tr>
                    <td style="text-align:left">Сфера <strong>Готовый бизнес</strong></td>
                    <td style="text-align:left">characteristic[199]</td>
                    <td style="text-align:center"><code>Number</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Тип объекта-складские помещени</td>
                    <td style="text-align:left">characteristic[159]</td>
                    <td style="text-align:center"><code>Number</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Тип объекта-производственные помещения</td>
                    <td style="text-align:left">characteristic[162]</td>
                    <td style="text-align:center"><code>Number</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Действующий бизнес</td>
                ...
                <tr>
                    <td style="text-align:left">Цена/месяц <strong>Аренда</strong></td>
                    <td style="text-align:left">characteristic[235][from] - characteristic[235][to]</td>
                    <td style="text-align:center"><code>Number[]</code></td>
                </tr>
                <tr>
                    <td style="text-align:left">Дополнительные платежи <strong>Аренда</strong></td>
